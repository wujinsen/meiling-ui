...
> **后端设计**：[sso-menu-system-isolation.md](../../moli-project-distribute/docs/design/sso-menu-system-isolation.md)
...
| 项 | 期望 |
|----|------|
| user-center | `:8888` 已合入 **SSO-MENU-1** 后端 + 执行 `moli-project-distribute/docs/sql/30_sso_menu_system_id.sql`（P1 backfill） |
...
- [sso-menu-frontend-handoff.md](../api/sso-menu-frontend-handoff.md) — F-SSO-1～6 · `reloadRoutesFromServer` TS 示例
- [frontend-backend-dependencies.md](../api/frontend-backend-dependencies.md) §5
- [sso-frontend-dev-guide.md](../sso-frontend-dev-guide.md)
- [per-system-menu-isolation.md](../per-system-menu-isolation.md)
