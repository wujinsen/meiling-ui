...
<template>
  ...
  >
    <p class="text-sm font-medium text-gray-500 dark:text-gray-400">{{ t(labelKey) }}</p>
    ...
    <p v-else-if="subKey" class="mt-1 text-sm text-gray-400 dark:text-gray-500">{{ t(subKey) }}</p>
  </component>
</template>
