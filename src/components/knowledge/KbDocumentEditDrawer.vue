...
<template>
  <Teleport to="body">
    <Transition name="kb-doc-drawer">
      <div v-if="open" class="kb-doc-drawer-backdrop" @click.self="emit('close')">
        <aside class="kb-doc-drawer" role="dialog" aria-modal="true" @click.stop>
          <header class="kb-doc-drawer-header">
            <button type="button" class="kb-doc-drawer-close" :aria-label="t('confirm.cancel')" @click="emit('close')">
              <X class="h-5 w-5" />
            </button>
          ...
          <div v-else-if="detail" class="kb-doc-drawer-body">
