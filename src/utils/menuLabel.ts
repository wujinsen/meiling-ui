...
const MENU_COMPONENT_TITLE_KEYS: Record<string, string> = {
  ...
  'operation/deploy/index': 'operation.deployCenter.title',
  'operation/task/index': 'operation.taskHistory.title',
  'operation/port-matrix/index': 'operation.portMatrix.title',
  ...
  'knowledge/wiki-govern/index': 'knowledge.wikiGovern.title',
  'knowledge/wiki/govern/index': 'knowledge.wikiGovern.title',
...
const MENU_NAME_TITLE_KEYS: Record<string, string> = {
  ...
  部署中心: 'operation.deployCenter.title',
  任务历史: 'operation.taskHistory.title',
  端口矩阵: 'operation.portMatrix.title',
