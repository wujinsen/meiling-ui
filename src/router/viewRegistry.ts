...
const CRM_VIEWS: Record<string, () => Promise<Component>> = {
  ...
  'operation/task/index': () => import('@/views/operation/TaskHistoryView.vue'),
  'operation/port-matrix/index': () => import('@/views/operation/PortMatrixManageView.vue'),
  'operation/topology/index': () => import('@/views/operation/OperationTopologyGraphView.vue'),
  'operation/aiops/index': () => import('@/views/operation/AiopsDiagnosisView.vue'),
  'operation/aiops-runs/index': () => import('@/views/operation/AiopsRunsView.vue'),
  ...
  'knowledge/wiki/govern/index': () => import('@/views/knowledge/KnowledgeWikiGovernView.vue'),
  'knowledge/ops/dashboard/index': () => import('@/views/knowledge/KnowledgeOpsDashboardView.vue'),
