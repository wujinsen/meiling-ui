...
import type { SeriesPoint } from '@/types/cockpit'

use([CanvasRenderer, LineChart, GridComponent, TooltipComponent, LegendComponent])

const props = defineProps<{ data: SeriesPoint[] }>()
const { t } = useI18n()
...
const option = computed(() => {
  ...
  return {
    ...
    legend: {
      data: [t('cockpit.chart.actual'), t('cockpit.chart.target')],
